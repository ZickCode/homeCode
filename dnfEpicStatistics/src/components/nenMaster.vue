...
<script>
	export default {
		...
		mounted: function(){
			var self = this;
      var url = (window.location.host == '' || !window.location.host.indexOf("localhost") || !window.location.host.indexOf("127.0.0.1") || !window.location.host.indexOf("192.168.")) ? 'dnfEpicStatistics/src/assets/nenMaster.json' : 'src/assets/nenMaster.json';
